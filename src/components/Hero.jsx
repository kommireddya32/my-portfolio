...
import resumePDF from '../assets/KSanthoshResume.pdf';
import './Hero.css';
...
const Hero = () => {
  ...
  const codeLines = [
    ...
    { text: '  name: "Kommireddy Santhosh",' },
    { text: '  role: "Full Stack Developer",' },
    { text: '  location: "India",' },
    { text: '  skills: {' },
    { text: '    backend: ["Java", "Spring Boot", "Hibernate"],' },
    { text: '    frontend: ["React", "JavaScript", "HTML/CSS"],' },
    { text: '    database: ["MySQL", "Oracle"],' },
    { text: '  },' },
      ...
      <div className="hero-container">
        <div className="hero-content">
          ...
          <h2 className="hero-subtitle">
            Full Stack <span className="highlight">Java Developer</span>
          </h2>
          ...
          <p className="hero-description">
            ...
            training with internship at TAP Academy.
          </p>
