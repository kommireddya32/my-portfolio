    ...
    <section id="projects" className="projects">
      <div className="projects-container">
        ...
        <div className="view-all-container">
          <button className="view-all-btn" onClick={toggleAllProjects}>View All Projects</button>
        </div>
          ...
          <div className="projects-modal">
            <div className="projects-modal-content">
              <div className="modal-header">
                <h2>All Projects</h2>
                <button className="close-modal" onClick={toggleAllProjects}>
                  <X size={24} />
                </button>
              </div>
              <div className="projects-grid modal-grid">
                {allProjects.map((project, index) => renderProjectCard(project, index))}
              </div>
            </div>
          </div>
        )}
